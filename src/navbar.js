        ...
        return(
            <nav className = "navham">
                ...
                <div className = "navbar">
                    ...
                    <a href = "team" className = "navlinks last--link">Team</a>       
                    <a href = "achievements" className = "navlinks">Achievements</a>                                
                    <a className = "navlinks" href = "#contactUs" onClick = {hide}>Contact Us</a>
                    <a className = "navlinks" href = "#testimonials" onClick = {hide}>Testimonials</a>
                    <a className = "navlinks" href = "#insight" onClick = {hide}>App Insight</a>     
                </div>  

                <div className = "hamburgera"></div>

                <ul className = "hammenu">
                    <li><a className = "hamlink" href = "#insight" onClick = {hide}>App Insight</a></li>
                    <li><a className = "hamlink" href = "#testimonials" onClick = {hide}>Testimonials</a></li>
                    ...
                    <li><a href = "team" className = "hamlink">Team</a></li>                             
                </ul>
